...
def launch_experiments(exp_factors):
    ...
    for i in range(len(sizes)):
        ...
        with open(xp_file, 'a') as xp:
            xp.write(co.HTTPFILE+':random\n')
            xp.write(co.HTTPFILESIZE+':'+str(sizes[i])+'\n')
            xp.write(co.CURLTIMEOUT+':'+str(args.timeout)+'\n')
